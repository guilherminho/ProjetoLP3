...
public class GUIListagemTipo extends JDialog {
    ...
    public GUIListagemTipo(List<Tipo> texto) {
        setTitle("Listagem de Tipo");
        ...
        for (int i = 0; i < texto.size(); i++) {
            String[] linha = new String[]{String.valueOf(texto.get(i).getIdTipo()), String.valueOf(texto.get(i).getNome()),};
            model.addRow(linha);
            painelTa.add(scroll);
