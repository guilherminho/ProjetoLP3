...
String[] colunas = new String[]{"Cpf", "Login", "Senha", "Nome", "Endereco", "Telefone", };
String[][] dados = new String[0][3];
DefaultTableModel model = new DefaultTableModel(dados, colunas);
JTable tabela = new JTable(model);
scroll.setViewportView(tabela);
for (int i = 0; i < texto.size(); i++) {
String[] linha = new String[]{String.valueOf(texto.get(i).getCpf()), String.valueOf(texto.get(i).getLogin()), String.valueOf(texto.get(i).getSenha()), String.valueOf(texto.get(i).getNome()), String.valueOf(texto.get(i).getEndereco()), String.valueOf(texto.get(i).getTelefone()), };
model.addRow(linha);
painelTa.add(scroll);
