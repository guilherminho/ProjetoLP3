...
String[] colunas = new String[]{"IdProduto", "Nome", "Preco", "Descricao", "Caminho", "IdMarca", "IdTipo", };
String[][] dados = new String[0][3];
DefaultTableModel model = new DefaultTableModel(dados, colunas);
JTable tabela = new JTable(model);
scroll.setViewportView(tabela);
for (int i = 0; i < texto.size(); i++) {
String[] linha = new String[]{String.valueOf(texto.get(i).getIdProduto()), String.valueOf(texto.get(i).getNome()), String.valueOf(texto.get(i).getPreco()), String.valueOf(texto.get(i).getDescricao()), String.valueOf(texto.get(i).getCaminho()), String.valueOf(texto.get(i).getIdMarca()), String.valueOf(texto.get(i).getIdTipo()), };
model.addRow(linha);
painelTa.add(scroll);
