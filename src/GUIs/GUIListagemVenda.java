...
String[] colunas = new String[]{"IdVenda", "Data", "IdCliente", };
String[][] dados = new String[0][3];
DefaultTableModel model = new DefaultTableModel(dados, colunas);
JTable tabela = new JTable(model);
scroll.setViewportView(tabela);
for (int i = 0; i < texto.size(); i++) {
String[] linha = new String[]{String.valueOf(texto.get(i).getIdVenda()), sdf.format(texto.get(i).getData()), String.valueOf(texto.get(i).getIdCliente()), };
model.addRow(linha);
painelTa.add(scroll);
